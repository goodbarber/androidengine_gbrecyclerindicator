...
public class SampleCustomWidthIndicator extends GBRecyclerViewIndicator<SampleItemView, SampleIndicatorData, SampleItemView.SampleItemUIParams>
{

    public SampleCustomWidthIndicator(SampleIndicatorData dataObject)
    {
        super(dataObject);
    }
    ...
    {
        return getObjectData().getPercentageWidth();
    }
    ...
    public SampleItemView.SampleItemUIParams getUIParameters(String s)
    {
        ...
        uiParams.textColor = Color.GREEN;
        uiParams.backgroundColor = Color.RED;
        return uiParams;
    }
}
