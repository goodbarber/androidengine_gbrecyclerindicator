...
public class SampleFullWidthIndicator extends GBRecyclerViewIndicator<SampleItemView, SampleIndicatorData, SampleItemView.SampleItemUIParams>
{

    public SampleFullWidthIndicator(SampleIndicatorData dataObject)
    {
        super(dataObject);
    }
    ...
    public SampleItemView.SampleItemUIParams getUIParameters(String s)
    {
        ...
        uiParams.textColor = Color.BLUE;
        uiParams.backgroundColor = Color.GREEN;
        return uiParams;
    }
}
